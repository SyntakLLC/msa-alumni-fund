<template>
    <app-layout>
        <div class="bg-white">
            <div class="max-w-7xl mx-auto py-16 sm:px-2 lg:px-4">
                <div class="max-w-2xl mx-auto px-4 lg:max-w-none">
                    <div class="max-w-3xl">
                        <h2 class="font-semibold text-gray-500 mb-2">
                            MSA Alumni Fund
                        </h2>
                        <page-title> Our mission </page-title>
                        <page-subtitle>
                            The Drawstring Canister comes with multiple strap
                            and handle options to adapt throughout your day.
                            Shoulder sling it, backpack it, or handy carry it.
                        </page-subtitle>
                    </div>

                    <div
                        class="space-y-16 pt-10 mt-10 border-t border-gray-200 sm:pt-16 sm:mt-16"
                    >
                        <div
                        ...
                        >
                            <div
                                class="mt-6 lg:mt-0 lg:col-span-5 xl:col-span-4"
                            >
                            ...
                            <div class="flex-auto lg:col-span-7 xl:col-span-8">
                                <div
                                    class="aspect-w-5 aspect-h-2 rounded-lg bg-gray-100 overflow-hidden"
                                >
                                    <img
